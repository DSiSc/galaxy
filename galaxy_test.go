...
func TestNewGalaxyPlugin(t *testing.T) {
	...
	monkey.Patch(consensus.NewConsensus, func(participates.Participates, consensusConfig.ConsensusConfig, account.Account, chan<- interface{}) (consensus.Consensus, error) {
